 ...
 * [actan.yml](actan.yml)
     * Determines how your purl.obolibrary.org/obo/actan/ redirects will be handled
     ...
     * Paste in the contents of [actan.yml](actan.yml)
 ...
 * [actan.md](actan.md)
     ...
     * Paste in the contents of [actan.md](actan.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
